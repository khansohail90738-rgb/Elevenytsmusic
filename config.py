...
class Config:
    ...
    def __init__(self):
        ...
        self.SUPPORT_CHANNEL: str = getenv(
            "SUPPORT_CHANNEL", "https://t.me/Leob2343")
        self.SUPPORT_CHAT: str = getenv("SUPPORT_CHAT", "https://t.me/Leob2343")
        # ============ EXCLUDED CHATS ============
        ...
        self.START_IMG: str = getenv(
            "START_IMG", "https://i.ibb.co/8nM521Wq/photo-2026-05-08-18-35-55.jpg")  # Start command image
